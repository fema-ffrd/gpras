...
# %% define paths
# inputs
path_hf_results = r"/workspaces/gpras/production/post_processing/data/df_hf_test_data_depth_ave.csv"
path_lf_results = r"/workspaces/gpras/production/post_processing/data/df_lf_test_data_depth_ave.csv"
path_y_test_results = r"/workspaces/gpras/production/post_processing/data/y_test_pred_depth_ave.csv"
...
for event_id in event_id_list:
    ...
    # define paths
    path_plots = rf"/workspaces/gpras/production/post_processing/plots_ave/{gpr}//"
    ...
    folder_plots = rf"/workspaces/gpras/production/post_processing/plots_ave/{gpr}//"
    ...
    #
    list_cell_ids = ["38372", "37899", "53880", "51292", "2305", "87788"]
    list_cell_labels = [
    ...
    for i in np.arange(6):
        ...
        ax.plot(list_ts, lf_vals, color="0.5", ls="-", alpha=0.5, label="LF Model")
        if i == 1:
